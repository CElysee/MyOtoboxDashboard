            ...
            {showModal && (
              <>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="car_price_per_day" className="form-label">
                        Price/Day - Inside KGL
                      </label>
                      <input
                        type="number"
                        className="form-control"
                        id="car_price_per_day"
                        name="car_price_per_day"
                        placeholder="15000000"
                        onChange={handleInputChange}
                        value={inputValues.car_price_per_day}
                        required
                      />
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="car_price_per_week" className="form-label">
                        Price/ Week + - Inside KGL
                      </label>
                      <input
                        type="number"
                        className="form-control"
                        id="car_price_per_week"
                        name="car_price_per_week"
                        placeholder="15000000"
                        onChange={handleInputChange}
                        value={inputValues.car_price_per_week}
                        required
                      />
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="car_price_per_month" className="form-label">
                        Price/ Month + - Inside KGL
                      </label>
                      <input
                        type="number"
                        className="form-control"
                        id="car_price_per_month"
                        name="car_price_per_month"
                        placeholder="15000000"
                        onChange={handleInputChange}
                        value={inputValues.car_price_per_month}
                        required
                      />
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="car_price_per_day_up_country" className="form-label">
                        Price/Day - Outside KGL
                      </label>
                      <input
                        type="number"
                        className="form-control"
                        id="car_price_per_day_up_country"
                        name="car_price_per_day_up_country"
                        placeholder="15000000"
                        onChange={handleInputChange}
                  ...
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="car_price_per_day_up_country" className="form-label">
                        Price/ Week - Outside KGL
                      </label>
                      <input
                        type="number"
                        className="form-control"
                        id="car_price_per_week_up_country"
                        name="car_price_per_week_up_country"
                        placeholder="15000000"
                        onChange={handleInputChange}
                        value={inputValues.car_price_per_week_up_country}
                        required
                      />
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div>
                      <label htmlFor="car_price_per_month_up_country" className="form-label">
                        Price/ Month - Outside KGL
                      </label>
                      <input
                        type="number"
                        className="form-control"
                        id="car_price_per_month_up_country"
                        name="car_price_per_month_up_country"
                        placeholder="15000000"
                        onChange={handleInputChange}
                        value={inputValues.car_price_per_month_up_country}
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="col-lg-4">
                    <div>
                      ...
                      <input
                        ...
                        name="car_renter_name"
                        value={inputValues.car_renter_name}
                        onChange={handleInputChange}
                        required
                      />
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div>
                      ...
                      <input
                        type="number"
                        className="form-control"
                        id="renter_phone_number"
                        placeholder="0782378433"
                        name="renter_phone_number"
                        value={inputValues.renter_phone_number}
                        onChange={handleInputChange}
                        required
                      />
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div>
                      ...
                      <input
                        ...
                        name="renter_email"
                        value={inputValues.renter_email}
                        onChange={handleInputChange}
                      />
                    </div>
                  </div>
